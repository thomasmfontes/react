...
export default function HomeScreen({ navigation, route }) {
  ...
  return (
    <Container>
      ...
      <DateTextTop>{new Date().toLocaleDateString()}</DateTextTop>
      ...
      <View style={{}}>
        <ButtonRow>
          <FilterButton active={filter === 'pending'} onPress={() => setFilter('pending')}>
            <FilterButtonText>Pendente</FilterButtonText>
          </FilterButton>
          <FilterButton active={filter === 'completed'} onPress={() => setFilter('completed')}>
            <FilterButtonText>Completo</FilterButtonText>
          </FilterButton>
          <FilterButton active={filter === 'all'} onPress={() => setFilter('all')}>
            <FilterButtonText>Todos</FilterButtonText>
          </FilterButton>
        </ButtonRow>
      </View>
        ...
        <ModalContainer>
          <ModalContent>
            ...
            <DateContainer onPress={() => setShowDatePicker(true)}>
              <Ionicons name="calendar-outline" size={20} color="#F5F5F5" style={{ marginRight: 8 }} />
              <DateText>
                {selectedDate ? selectedDate.toLocaleDateString() : 'Selecionar Data de Vencimento'}
              </DateText>
            </DateContainer>
